...
while True:
    ...
    # if len(frames_buffer) > max_biffer_size:
    #     frames_buffer.pop(0)
    # frames_buffer.append(gray)

    # firstFrame = frames_buffer[0]
    ...
    # smoothed_motion_feature = smoothing * smoothed_motion_feature + (1-smoothing) * motion_feature

    # i += 1
    # if i == print_freq:
    #     print(smoothed_motion_feature)
    #     i = 0
